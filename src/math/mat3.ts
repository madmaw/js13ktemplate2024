...
export function multiply(m: Mat3, ...rest: readonly Mat3[]): MutableMat3 {
  return rest.reduce(
    (
      [a00, a01, a02, a10, a11, a12, a20, a21, a22]: MutableMat3,
      [b00, b01, b02, b10, b11, b12, b20, b21, b22]: Mat3,
    ): MutableMat3 => [
      // 0
...
export function fromMat2D([a0, a1, a2, a3, a4, a5]: Mat2D): MutableMat3 {
  return [a0, a1, 0, a2, a3, 0, a4, a5, 1];
}
